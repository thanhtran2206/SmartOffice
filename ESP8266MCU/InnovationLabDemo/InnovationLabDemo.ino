...
#include "src/model/infomodel/SimpleTemperature.h"
#include "src/model/infomodel/SimpleHumidity.h"
...
String deviceId = "net.tranminhthanh.smartthing:device02";
String authId = "net.tranminhthanh.smartthing_device02";
const char* device_password = "thanh123456";

/* Payload Configuration*/
String ditto_topic = "net.tranminhthanh.smartthing/device02";
...
com_bosch_iotacademy_tutorial::SimpleTemperature infoModelTemperature;
com_bosch_iotacademy_tutorial::SimpleHumidity infoModelHumidity;
com_bosch_iotacademy_tutorial::SimpleIlluminance infoModelIlluminance;
...
boolean publishTemperature() {			
		String mqttPayload = infoModelTemperature.temperature.serialize(ditto_topic ,deviceId, "temperature");	  
...
boolean publishHumidity() {      
    String mqttPayload = infoModelHumidity.humidity.serialize(ditto_topic ,deviceId, "humidity");
    /* Debug output on console */
...
boolean publishIlluminance() {      
    String mqttPayload = infoModelIlluminance.illuminance.serialize(ditto_topic ,deviceId, "illuminance");
    /* Debug output on console */
...
void setup() {		    
   ...
   /* Create a MQTT client ID */
    ...
    /*Test MQQT Client*/
    //mqttClient.publish("temperature","Test OK!!!");
}
...
void loop() {		
    ...
    if (now - lastMqttMsg > MQTT_DATA_PERIOD) {
        ...
        //Status Properties
        	...
        	infoModelTemperature.temperature.setvalue(value);

          value.setcurrentMeasured(humidity);
          //value.setminMeasured(dummy_value);
          //value.setmaxMeasured(dummy_value);
          infoModelHumidity.humidity.setvalue(value);

          illuminance = lux;
          value.setcurrentMeasured(illuminance);
          //value.setminMeasured(dummy_value);
          //value.setmaxMeasured(dummy_value);
          infoModelIlluminance.illuminance.setvalue(value);
